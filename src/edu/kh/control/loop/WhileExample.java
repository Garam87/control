...
public class WhileExample {
	...
	public void ex1() {
		...
		while(input != 9) { // input이 9가 아닐때 반복
			...
			switch(input) {
			case 1 : System.out.println("떡볶이 주문 완료!"); 
				break;
			case 2 : System.out.println("김밥 주문 완료!");
				break;
			case 3 : System.out.println("쫄면 주문 완료!");
				break;
			case 9 : System.out.println("키오스크를 종료합니다!");
				break;
	...
	public void ex4() {
		...
		do {
			System.out.print("0을 넣으면 합계가 출력이 된다 : ");
			input = sc.nextInt();
